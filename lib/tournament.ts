...
export function generateSchedule(
  ...
  for (let r = 0; r < numRounds; r++) {
    // Note: Math.random() makes tests non-deterministic if length % 4 !== 0
    // but we can sort deterministically for ties if needed.
    // Here we preserve original behavior.
...
export function calculateLeaderboard(
  ...
  // Ignore players who haven't played any games yet
