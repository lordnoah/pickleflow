                ...
                >
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <button
                      ...
                      className={`w-full py-4 rounded-xl font-black text-xs uppercase flex items-center justify-center gap-2 transition-all active:scale-95 ${match.completed ? 'bg-slate-100 text-slate-500' : 'bg-lime-600 text-white shadow-lg'}`}
                    >
                      {match.completed ? (
                        <>
